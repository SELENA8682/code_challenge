from service.employee_config import Manager


employee_dict = {}
manager_dict = {}
class Employee_organized_data:
    def link_manager_with_em_id(self,employee_list):
    ...
    def get_total_salary(self,employee_list):
        if employee_list:
